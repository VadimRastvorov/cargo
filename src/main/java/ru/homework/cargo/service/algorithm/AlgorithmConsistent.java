...
@Service
public class AlgorithmConsistent implements AlgorithmService {
    ...
    public List<char[][]> invoke(TruckLoad truckLoad) {
        ...
        for (String parcel : truckLoad.getParcels()) {
            ...
            CargoPosition cargoPosition = cargoService.returnStartPosition(parcelChar, trucks.get(truckIndex % trucks.size()));
